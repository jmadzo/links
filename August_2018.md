...
[scRNAseq clustering comparison](https://github.com/markrobinsonuzh/scRNAseq_clustering_comparison)

[STARmap](https://github.com/weallen/STARmap)
...
[Massive single-cell RNA-seq analysis and imputation via deep learning](https://www.biorxiv.org/content/early/2018/07/26/315556)

[A systematic performance evaluation of clustering methods for single-cell RNA-seq data](https://f1000research.com/articles/7-1141/v1)

[Single-cell RNA-seq of human induced pluripotent stem cells reveals cellular heterogeneity and cell state transitions between subpopulations](https://genome.cshlp.org/content/28/7/1053.full)

[Using an atlas of gene regulation across 44 human tissues to inform complex disease- and trait-associated variation](https://www.nature.com/articles/s41588-018-0154-4)

[Integrated Single-Cell Analysis Maps the Continuous Regulatory Landscape of Human Hematopoietic Differentiation](https://www.cell.com/cell/fulltext/S0092-8674(18)30446-X)
...
[ERVcaller](http://www.uvm.edu/genomics/software/ERVcaller.html)

[TEcandidates](https://github.com/TEcandidates/TEcandidates)

[RetroSpotter](https://github.com/NCBI-Hackathons/RetroSpotter)
...
[Ultraconserved elements (UCEs)](https://www.frontiersin.org/articles/10.3389/fgene.2012.00199/full)

--------

[Grantome: Cell-intrinsic mechanisms of endogenous retroviral control](http://grantome.com/grant/NIH/F30-AI129265-01)

--------

## Papers
[A repetitive elements perspective in Polycomb epigenetics](https://www.frontiersin.org/articles/10.3389/fgene.2012.00199/full)

[Ultraconserved Elements in the Human Genome](http://www.genetics.org/content/192/1/253)

[ERVcaller: Identifying and genotyping non-reference unfixed endogenous retroviruses (ERVs) and other transposable elements (TEs) using next-generation sequencing data](https://www.biorxiv.org/content/early/2018/07/11/332833)

[TEcandidates: prediction of genomic origin of expressed transposable elements using RNA-seq data](https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/bty423/5026658)
...
[Next-Gen Sequence Analysis Workshop (2018)](http://angus.readthedocs.io/en/2018/)

[IHEC tools](http://ihec-epigenomes.org/research/tools)

## Expresion vs Epigenetics

[DEScan2](https://bioconductor.org/packages/release/bioc/vignettes/DEScan2/inst/doc/DEScan2.html)

[Coordinated Gene Activity in Pattern Sets](https://www.bioconductor.org/packages/release/bioc/html/CoGAPS.html)

## Genome Annotation
[Genomation: a toolkit for annotation and visualization of genomic data](https://bioconductor.org/packages/release/bioc/vignettes/genomation/inst/doc/GenomationManual.html)
...
[Segtools](https://segtools.hoffmanlab.org)
...
[A brief guide to data visuals in R in 2018](https://www.r-bloggers.com/a-brief-guide-to-data-visuals-in-r-in-2018)

## Stats
[Moving beyond P values: Everyday data analysis with estimation plots](https://www.biorxiv.org/content/early/2018/07/26/377978)

### Varia
[cga-modules](https://github.com/astojmir/cgamodules#adding-new-datasets)

[FANTOM5](http://fantom.gsc.riken.jp/5/)

#### Papers

[Integrative CAGE and DNA Methylation
Profiling](http://mcr.aacrjournals.org/content/molcanres/15/10/1354.full.pdf)

[Transcriptome Analysis of Recurrently Deregulated Genes across Multiple Cancers Identifies New Pan-Cancer Biomarkers](http://cancerres.aacrjournals.org/content/76/2/216.long)

[ISMARA: automated modeling of genomic signals as a democracy of regulatory motifs](https://genome.cshlp.org/content/24/5/869.long)

[ISMARA: automated modeling of genomic signals as a democracy of regulatory motifs](https://www.ncbi.nlm.nih.gov/pubmed/24515121)
...
## Blogs
[Classification from scratch, logistic with splines 2/8](https://www.r-bloggers.com/classification-from-scratch-logistic-with-splines-2-8/)

[Classification from scratch, logistic with kernels 3/8](https://www.r-bloggers.com/classification-from-scratch-logistic-with-kernels-3-8/)
...
[Machine Learning FAQ](https://sebastianraschka.com/faq/docs/lda-vs-pca.html)
...
Based on Random Projection](https://arxiv.org/abs/1706.04371)

[A survey of dimensionality reduction techniques](https://arxiv.org/pdf/1403.2877.pdf)

[Dimensionality Reduction and Principal Component Analysis](https://www.commonlounge.com/discussion/fa86fe1108f64c7ab207f4e5bb4e568e)

[Contrastive Principal Component Analysis](https://arxiv.org/pdf/1709.06716.pdf)

[UMAP](https://github.com/lmcinnes/umap)

[Enter the matrix: factorization uncovers knowledge from omics](https://www.biorxiv.org/content/early/2018/04/02/196915)

[Annoy (Approximate Nearest Neighbors)](https://github.com/spotify/annoy#readme)
...
[Mining of Massive Datasets Course](https://lagunita.stanford.edu/courses/course-v1:ComputerScience+MMDS+SelfPaced/about)
...
## Papers
[Hoffman: Machine Learning for Integrating Data in Biology and Medicine](https://arxiv.org/abs/1807.00123)
...
[Identification of rare de novo epigenetic variations in congenital disorders](https://www.nature.com/articles/s41467-018-04540-x.pdf)
...
[Tools for extracting individual genomes from metagenomes](https://github.com/KasperSkytte/mmgenome2)

[Microglial control of astrocytes in response to microbial metabolites](https://www.nature.com/articles/s41586-018-0119-x)
...
[CIS-BP](http://cisbp.ccbr.utoronto.ca/TFreport.php?searchTF=T139289_1.02)
...
[Somatic mutations precede acute myeloid leukemia years before diagnosis](https://www.nature.com/articles/s41591-018-0081-z)

[Prediction of acute myeloid leukaemia risk in healthy individuals](https://www.nature.com/articles/s41586-018-0317-6)

[Making Mistakes Empowers Cancer Cells](https://www.cell.com/trends/cancer/fulltext/S2405-8033(18)30112-2)

[How does normalization impact RNA-seq disease diagnosis?](https://www.sciencedirect.com/science/article/pii/S1532046418301424)
